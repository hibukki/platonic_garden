...
class VL53L0X():
    ...
    def set_address(self, new_address):
        ...
        This allows using multiple VL53L0X sensors on the same I2C bus.
        Valid addresses are 0x08 to 0x77 (inclusive).
        This function should be called after init() but before any other setup.
        
        Args:
            new_address: New I2C address for the sensor (7-bit)
        ...
        # Write the new address to the I2C_SLAVE_DEVICE_ADDRESS register
        self._register(I2C_SLAVE_DEVICE_ADDRESS, new_address & 0x7F)
        
        # Update the address in the class instance
